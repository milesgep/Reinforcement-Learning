...
def main():
	...
	#alphas = np.random.uniform(0.0001, 0.005, 5)
	#epsilons = np.random.uniform(0.01, 1.0, 5)


	# graphed epsilon greedy values
	epsilon = 0.12057230413375797 
	alpha = 0.004811779631035748
	greedy = True
	#fourier_basis = 5
	fourier_basis = 3
	...
	# best softmax values
	epsilon = 0.9060112357728144 
	alpha = 0.004103295957718592
	greedy = False

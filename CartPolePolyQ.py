...
class Agent:
	...
	def run(self, MDP, weight_matrix):
		...
		while time_step != MDP.max_time:
			...
			#weight_matrix = TD_update(previous_position, position, reward, self.gamma, self.alpha, self.q_table, weight_matrix)
...
def main():
	...
	# graphed values
	epsilon = 0.09481604201187051 
	alpha = 7.122570113144659e-06
